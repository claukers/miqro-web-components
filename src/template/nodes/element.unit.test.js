...
const testOptions = {
  category: "template.nodes.element unit tests"
};
...
it("dataIf returns true dataIfn return true", happyPath(true, true, true), testOptions);

it("dataIf returns false dataIfn return true", happyPath(false, false, true), testOptions);

it("dataIf returns true dataIfn return false", happyPath(false, true, false), testOptions);

it("dataIf returns false dataIfn return false", happyPath(false, false, false), testOptions);
